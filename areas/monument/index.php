...
?>
<?php
$pageTitle       = 'Home Building & Construction in Monument, OR | Superior Home Builders';
$pageDescription = 'Superior Home Builders serves Monument, OR with custom homes, remodeling, decks & framing in Grant County. Licensed Oregon contractor CCB# 147123. Free estimates.';
$canonicalUrl    = $siteUrl . '/areas/monument/';
$currentPage     = 'service-area';
$heroImage       = 'https://db.pageone.cloud/storage/v1/object/public/client-assets/superior-home-builders/photos/1780604103182-ak0uqe-20221109_161614_1_.jpg';
...
$breadcrumbs = generateBreadcrumbSchema([
  ...
  ['name' => 'Monument',      'url' => $siteUrl . '/areas/monument/'],
]);

$localBusiness = [
  '@context' => 'https://schema.org',
  '@type'    => 'HomeAndConstructionBusiness',
  '@id'      => $siteUrl . '/areas/monument/#local',
  'name'     => $siteName,
  'url'      => $siteUrl . '/',
  'telephone' => $phone,
  'address'  => [
...
$faqs = [
  [
    'q' => 'Does Superior Home Builders serve Monument, OR?',
    'a' => 'Yes — Monument is a service area for Superior Home Builders. We\'re based in Mount Vernon and work in Monument on custom home builds, remodels, deck construction, framing, and other general contracting projects. Monument falls within Grant County, and we file all permits through the Grant County Building Department in Canyon City, which we\'ve worked with regularly since 2001.',
  ],
  [
    'q' => 'What are the biggest construction challenges for homes near Monument at 2,800 feet?',
    'a' => 'Monument sits at 2,800 feet along the North Fork John Day River in the rugged terrain of north-central Grant County. The combination of canyon micro-climates, significant freeze-thaw cycles, and the proximity to the river corridor can create foundation moisture issues and accelerated weathering on exterior wood and finishes. Ranch and forest properties in the Monument area also tend to have older structural framing that predates modern load requirements — we assess all of these factors before writing any estimate.',
  ],
  [
    'q' => 'Can Superior Home Builders work on ranch and forest properties near Monument?',
    'a' => 'Absolutely. Much of the land around Monument is ranch and forest property — some tied to federal grazing leases, others privately held as timber or hunting acreage. We have experience working on structures associated with these property types, including outbuildings, shop buildings, and residential dwellings on large rural parcels. Access, site prep on unimproved roads, and material delivery logistics to the Monument area are challenges we\'ve navigated many times across Grant County.',
  ],
];
...
<style>
/* ════════════════════════════════════════════════════════════════════
   MONUMENT SERVICE AREA — Superior Home Builders
   ...
   services grid, why-us points, FAQ accordion, SVG dividers,
...
<section class="area-hero" aria-label="Monument service area">
  <div class="area-hero-floating" aria-hidden="true"></div>
  <div class="area-hero-inner">
    <div class="container">
      <span class="area-hero-eyebrow"><?php echo lucide_icon('map-pin'); ?> Monument, OR &middot; North Fork John Day River &middot; Grant County</span>
      <h1>Home Building &amp; Construction in<br><em>Monument, OR</em></h1>
      <p class="area-hero-answer">Superior Home Builders serves Monument with custom home construction, remodeling, deck building, and framing along the North Fork John Day River corridor in north-central Grant County. Our crew is based in Mount Vernon and understands the canyon terrain, ranch properties, and isolated forest parcels that define construction near Monument at 2,800 feet elevation.</p>
      <div class="area-hero-trust">
        <span class="area-hero-trust-item"><?php echo lucide_icon('mountain'); ?> 2,800 ft elevation expertise</span>
      ...
      <div class="area-hero-actions">
        <a href="/contact/" class="btn btn-secondary btn-lg">Get a Free Estimate in Monument</a>
        <?php if (!empty($phone)): ?>
      ...
      <nav class="area-breadcrumb" aria-label="Breadcrumb">
        ...
        <span aria-current="page">Monument</span>
      </nav>
    </div>
  </div>
</section>
...
<!-- INTRO SPLIT -->
<section class="area-intro" aria-label="About construction in Monument, OR">
  <div class="area-intro-watermark" aria-hidden="true">MONUMENT</div>
  <div class="container">
    <div class="area-intro-grid">
      <div class="reveal-left">
        <h2>What makes building and remodeling in Monument, OR different from other Grant County communities?</h2>
        <p class="answer-block">Monument is one of the most remote communities in Grant County — a small community of approximately 130 residents along the North Fork John Day River, set within canyon terrain at 2,800 feet. The rugged north-central Grant County landscape shapes everything about construction here: access to remote ranch and forest parcels, exposure to the river canyon's distinct micro-climate, and a housing stock that largely predates modern building codes. Custom home builds and remodels near Monument require a contractor who plans for the logistics of getting materials and crews to where they're needed in this part of Oregon's high desert backcountry.</p>
        <p class="area-identity">Superior Home Builders is a licensed Oregon general contractor (CCB# 147123) based in Mount Vernon, serving Monument and Grant County with custom home building, remodeling, and construction since 2001.</p>
      ...
      <div class="reveal-scale">
        <div class="area-intro-photo">
          <img src="https://db.pageone.cloud/storage/v1/object/public/client-assets/superior-home-builders/photos/1780604103182-ak0uqe-20221109_161614_1_.jpg"
               alt="Construction project near Monument Oregon by Superior Home Builders"
               width="420" height="560" loading="lazy">
          <div class="area-intro-photo-tag">Serving Monument, OR — 25+ Years</div>
        </div>
      </div>
    </div>
  </div>
...
<!-- LOCAL SIGNALS BENTO -->
<section class="area-locals" aria-label="Monument construction context">
  <div class="container">
    <div class="area-locals-header reveal-up">
      <h2>Why does construction near Monument require local knowledge?</h2>
      <p>The North Fork John Day River canyon, the Ritter Hot Springs corridor, and Monument Elementary School community sit at the center of one of Oregon's most geographically distinctive construction environments.</p>
    </div>
    <div class="area-bento">
      <div class="area-bento-card reveal-up reveal-delay-1">
        <div class="icon-wrap"><?php echo lucide_icon('waves'); ?></div>
        <h3>North Fork John Day River terrain</h3>
        <p>Properties along the North Fork John Day River corridor face unique site conditions — canyon walls, flood-zone setback considerations, and riparian vegetation can all affect where structures can be placed and how foundations must be designed. We assess site-specific conditions before any Monument project starts.</p>
      </div>
      <div class="area-bento-card reveal-up reveal-delay-2">
        <div class="icon-wrap"><?php echo lucide_icon('thermometer'); ?></div>
        <h3>Canyon micro-climate and freeze cycles</h3>
        <p>Monument's canyon setting at 2,800 feet produces temperature inversions and frost pockets that can be more severe than surrounding higher-elevation terrain. Freeze-thaw cycles affect concrete footings, crawl spaces, and exterior finishes differently here than in more exposed locations. Every Monument project we build is spec'd with these local thermal conditions in mind.</p>
      </div>
      <div class="area-bento-card reveal-up reveal-delay-3">
        <div class="icon-wrap"><?php echo lucide_icon('trees'); ?></div>
        <h3>Ranch and forest property access</h3>
        <p>Much of the land surrounding Monument is held as ranch and forest property — some parcels accessible only by unimproved roads. Coordinating crew access and material deliveries to remote sites in this part of north-central Grant County is a logistics problem we've solved many times across 25 years of working in this region.</p>
      </div>
      <div class="area-bento-card reveal-up reveal-delay-4">
        <div class="icon-wrap"><?php echo lucide_icon('home'); ?></div>
        <h3>Older small-community housing stock</h3>
        <p>With approximately 130 residents, Monument's residential buildings span a range of eras, and many structures haven't been significantly updated since original construction. Common challenges include undersized electrical panels, minimal wall insulation, and aging plumbing — all of which we evaluate and price for honestly in every remodel estimate.</p>
      </div>
    </div>
  </div>
</section>
...
<!-- SERVICES -->
<section class="area-services" aria-label="Services available in Monument OR">
  <div class="container">
    <h2 class="reveal-up">Construction services available near me in <span class="text-accent">Monument, OR</span></h2>
    <div class="services-grid">
      <?php
      $serviceData = [
        ['slug'=>'custom-home-building','icon'=>'home','photo'=>'https://db.pageone.cloud/storage/v1/object/public/client-assets/superior-home-builders/photos/1780604270195-cqt47w-468298780_10161035683197734_2359719916650256082_n.jpg','bullets'=>['Full design-to-build service','River canyon site expertise','Grant County permitted']],
        ['slug'=>'general-remodeling','icon'=>'wrench','photo'=>'https://db.pageone.cloud/storage/v1/object/public/client-assets/superior-home-builders/photos/1780604102234-3xpgf4-20221109_161614.jpg','bullets'=>['Ranch home renovations','Additions &amp; interior updates','Structural assessments included']],
        ['slug'=>'kitchen-remodeling','icon'=>'utensils','photo'=>'https://db.pageone.cloud/storage/v1/object/public/client-assets/superior-home-builders/photos/1780604305411-iws3zu-467311955_10160913944502734_1381678653232378695_n.jpg','bullets'=>['Cabinets, countertops &amp; layout','Updated electrical &amp; plumbing','Permit coordination handled']],
        ['slug'=>'bathroom-remodeling','icon'=>'bath','photo'=>'https://db.pageone.cloud/storage/v1/object/public/client-assets/superior-home-builders/photos/1780604306051-1cn5ph-467748149_10161026648862734_1486565757297760050_n.jpg','bullets'=>['Shower conversions &amp; tiling','Vanity &amp; fixture upgrades','Full plumbing rough-in']],
        ['slug'=>'decks','icon'=>'tree-pine','photo'=>'https://db.pageone.cloud/storage/v1/object/public/client-assets/superior-home-builders/photos/1780604099376-0r19op-20220724_154635.jpg','bullets'=>['Canyon view deck builds','Freeze-cycle engineered','Composite &amp; treated wood']],
        ['slug'=>'framing','icon'=>'hammer','photo'=>'https://db.pageone.cloud/storage/v1/object/public/client-assets/superior-home-builders/photos/1780604094227-1d9fl5-20220724_151623.jpg','bullets'=>['New builds &amp; additions','Outbuilding &amp; shop framing','Structural repairs &amp; reinforcement']],
      ];
      ...
      <article class="service-card-with-image <?php echo $tints[$si % 3]; ?> reveal-up reveal-delay-<?php echo ($si % 4) + 1; ?>">
        <div class="service-card__image">
          <img src="<?php echo htmlspecialchars($sd['photo']); ?>"
               alt="<?php echo htmlspecialchars($svc['name']); ?> near Monument, OR by Superior Home Builders"
...
<!-- WHY SUPERIOR -->
<section class="area-why" aria-label="Why Superior Home Builders in Monument">
  <div class="container">
      ...
      <div class="reveal-scale">
        <div class="area-why-photo">
          <img src="https://db.pageone.cloud/storage/v1/object/public/client-assets/superior-home-builders/photos/1780604304191-9h3673-466678023_10160894523422734_2342757114398857707_n.jpg"
               alt="Superior Home Builders project in Grant County near Monument Oregon"
               width="480" height="600" loading="lazy">
          <div class="area-why-badge">Monument's Trusted Local Builder</div>
        </div>
      </div>
      <div class="reveal-right">
        <h2>Why hire Superior Home Builders for your Monument construction project?</h2>
        <p class="answer-block">Monument is one of the most remote communities in all of Grant County — and that raises the stakes when you hire a contractor who doesn't know the area. Getting to Monument, sourcing materials efficiently, managing permits through Canyon City, and building for the conditions of the North Fork John Day River canyon are things we've done for over 25 years. We don't treat Monument as an afterthought. It's part of Grant County, and Grant County is our home territory.</p>
        <div class="area-why-points">
          <div class="area-why-point">
            <span class="num">01</span>
            <div>
              <strong>We know north-central Grant County</strong>
              <span>The terrain, the access roads, the river corridor properties, and the isolated ranch parcels around Monument are familiar to us. When we give you an estimate on a Monument project, it reflects 25 years of working in this exact part of Oregon — not a guess based on more accessible locations.</span>
            </div>
          </div>
          <div class="area-why-point">
            <span class="num">02</span>
            <div>
              <strong>Remote site logistics planned from the start</strong>
              <span>Monument is a long drive from supply centers, and that reality has to be built into every project timeline and materials order. We don't discover mid-project that a delivery won't make it out here on time — we plan for it before the first tool hits the site.</span>
            </div>
          </div>
          <div class="area-why-point">
            <span class="num">03</span>
            <div>
              <strong>Canyon and river site experience</strong>
              <span>Properties along the North Fork John Day River bring considerations that don't apply to standard flat-lot construction — site slope, drainage, riparian setbacks, and micro-climate effects on foundation and framing. These are part of our standard assessment on every Monument project we take on.</span>
            </div>
          </div>
        </div>
...
<!-- FAQ -->
<section class="area-faq" aria-label="Monument construction FAQ">
  <div class="container">
    <h2 class="reveal-up">Common questions about construction near me in Monument, OR</h2>
    <p class="answer-block reveal-up reveal-delay-1">Answers for Monument homeowners and ranch property owners planning remodels, new builds, or additions in the 97864 zip code in north-central Grant County.</p>
...
<!-- FINAL CTA -->
<section class="area-final-cta" aria-label="Get a free estimate in Monument">
  <div class="container reveal-up">
    <h2>Ready to start your Monument project?</h2>
    <p>Superior Home Builders brings 25+ years of Grant County construction experience to Monument and the North Fork John Day River area. Free on-site estimate, written scope, honest timeline. We know this part of Oregon — and we'll treat your property right.</p>
    <div class="cta-row">
