 ...
 */
$pageTitle       = 'Off-Grid Solar Power in Eastern Oregon | Solar, Batteries & Backup Generators | Superior Home Builders';
...
<style>
/* ════════════════════════════════════════════════════════════════════
   BLOG POST — Solar Power for Off-Grid Homes in Eastern Oregon
   ...
   solar system comparison table, highlight and warning boxes
   ════════════════════════════════════════════════════════════════════ */
...
.blog-hero::before {
  ...
  background: linear-gradient(
    ...
    rgba(var(--color-secondary-rgb), 0.82) 45%,
