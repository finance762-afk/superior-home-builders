...
<style>
/* ════════════════════════════════════════════════════════════════════
   KITCHEN REMODELING — Superior Home Builders
   Premium page styles | var() tokens only | No hardcoded values
   Techniques: layered hero, bento problem cards, asymmetric expert
   section, process timeline, testimonials, comparison, FAQ accordion,
   floating decorative accent, multi-direction reveals, SVG dividers
   ════════════════════════════════════════════════════════════════════ */
...
.sp-hero::before {
  ...
  background: linear-gradient(115deg,
    rgba(var(--color-secondary-rgb),0.93) 0%,
...
.sp-hero-card {
  ...
  border-radius:16px; padding:var(--space-2xl); color:#fff;
}
...
.sp-problem-floating {
  position:absolute; top:var(--space-2xl); right:-60px;
  width:260px; height:260px; border-radius:50%;
  background:rgba(var(--color-accent-rgb),0.05);
  pointer-events:none;
}
.sp-problem-pull {
  font-family:var(--font-heading); font-size:clamp(1.5rem,2.8vw,2.4rem);
  ...
  max-width:70ch; margin:0 auto var(--space-3xl); line-height:1.4;
}
